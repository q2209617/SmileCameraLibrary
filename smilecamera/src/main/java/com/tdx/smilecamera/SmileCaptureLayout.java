...
//                resetCaptureLayout();
        ...
        LinearLayout ll_tips = new LinearLayout(getContext());
...
//        txt_param.gravity = Gravity.CENTER_HORIZONTAL;
        txt_param.setMargins(15, 0, 0, 0);
        txt_tip.setText("温馨提示：");
        txt_tip.setTextColor(0xFFFFFFFF);
        txt_tip.setTextSize(14);
        txt_tip.setGravity(Gravity.LEFT);
...
//        txt_tip_one.getPaint().setFakeBoldText(true);
        ...
        TextView txt_tip_two = new TextView(getContext());
...
//        txt_param.gravity = Gravity.CENTER_HORIZONTAL;
        ...
        ll_tips.addView(txt_tip_one);
        ll_tips.addView(txt_tip_two);
